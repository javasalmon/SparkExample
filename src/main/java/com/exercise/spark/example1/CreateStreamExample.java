...
public class CreateStreamExample {
	...
	public static void main(String[] args) throws IOException {
		...
		//Creating Streams using user/programmatically specified elements  
         ...
         //primitive streams
         System.out.println("Primitive Streams (Range)");
         IntStream.range(1, 4)
         .forEach(p -> System.out.println(p));

        System.out.println("Primitive Streams (Range Closed");
         ...
         //Streams from File
         Stream<String> streamOfStrings = Files.lines(Paths.get("/Users/rajeevsachdeva/spark/Apache-Spark-2x-for-Java-Developers/src/main/resources/Apology.txt"));
         Stream<String> streamWithCharset = Files.lines(Paths.get("/Users/rajeevsachdeva/spark/Apache-Spark-2x-for-Java-Developers/src/main/resources/Apology.txt"), Charset.forName("UTF-8"));
