...
public class BikeRentalPrediction {
   ...
   //  - maxDepth: max depth of each decision tree in the GBT ensemble
	...
	// In this exercise notebook, we keep these values small.  In practice, to get the highest accuracy, you would likely want to try deeper trees (10 or higher) and more trees in the ensemble (>100).
